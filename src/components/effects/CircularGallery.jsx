...
class Media {
    constructor({
      ...
      this.screen = screen;
      this.text = text;
      this.workPositionText = workPositionText;
      ...
      this.createShader();
      this.createMesh();
      this.createTitle();  // Inclui título superior e inferior
      this.createIcon();   // Adiciona o ícone central
      this.onResize();
    }
    ...
    createTitle() {
        ...
        this.workPositionText = new Title({
          gl: this.gl,
          plane: this.plane,
          renderer: this.renderer,
          text: this.workPositionText,
          textColor: this.textColor,
          fontFamily: this.font,
        });
  
      const height = this.plane.scale.y * 0.15;
      this.titleTop.mesh.position.y = this.plane.scale.y * 0.5 + height * 0.5 + 0.05;
      this.workPositionText.mesh.position.y = this.titleBottom.mesh.position.y - height - 0.01;
    }
    ...
    createIcon() {
        ...
        this.icon = new Mesh(this.gl, { geometry, program });
        const scaleFactorX = 0.5;
        const scaleFactorY = 0.1;
        
        this.icon.scale.set(scaleFactorX, scaleFactorY, 1);
        this.icon.position.z = 0.1;
        this.icon.setParent(this.plane);
      }
  ...
  createMedias(items, bend = 1, textColor, borderRadius, font) {
    ...
    this.medias = this.mediasImages.map((data, index) => {
      return new Media({
        ...
        workPositionText: data.workPositionText,
        icon: data.icon,
